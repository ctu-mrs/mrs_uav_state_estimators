...
PACKAGE="mrs_uav_state_estimation"
VERBOSE=1
...
# run the test
rostest $PACKAGE mrs_uav_state_estimation.test $TEXT_OUTPUT --results-filename=$PACKAGE.test --results-base-dir="$TEST_RESULT_PATH"
